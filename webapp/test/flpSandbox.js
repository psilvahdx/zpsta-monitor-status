		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#portosegurozpstastatusmon-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"portosegurozpstastatusmon-display": {
								"semanticObject": "portosegurozpstastatusmon",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=portoseguro.zpstastatusmon",
									"url": sap.ui.require.toUrl("portoseguro/zpstastatusmon")
								}
							}
						}
					}
